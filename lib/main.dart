  ...
  void initState() {
    ...
    section1Items.add(CPListSection(
      items: [
        ...
        CPListItem(
          text: "Item 2",
          detailText: "Bắt đầu thanh tiến trình",
          isPlaying: false,
          playbackProgress: 0,
          image: 'images/logo_flutter_1080px_clr.png',
          onPress: (complete, self) {
      ...
      home: Scaffold(
        ...
        body: Column(
          ...
          children: [
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () => addNewTemplate(
                    CPListTemplate(
                      sections: [],
                      title: "Màn hình trống",
                      emptyViewTitleVariants: ["Ví dụ màn hình trống"],
                      emptyViewSubtitleVariants: [
                        "Bạn vừa thêm một màn hình trống vào carplay từ iphone của mình.",
                      ],
                      showsTabBadge: true,
                      systemIcon: "airpods",
                    ),
            ...
            Center(
              child: Text(
                'Trạng thái Carplay: ${CPEnumUtils.stringFromEnum(connectionStatus)}',
              ),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
            ...
            ElevatedButton(
              ...
              child: const Text('Buộc cập nhật Carplay'),
            ),
